...
extension SSGC {
    ...
    @frozen public struct Decl: Identifiable, Equatable, Sendable {
        ...
        public internal(set) var requirements: Set<Symbol.Decl>

        /// Enumeration cases.
        public internal(set) var inhabitants: Set<Symbol.Decl>
        ...
        public internal(set) var superforms: Set<Symbol.Decl>
        ...
        public internal(set) var origins: Set<Symbol.Decl>
        public internal(set) var kinks: Phylum.Decl.Kinks
...
extension SSGC.Decl {
    @inlinable public var traits: UCF.DisambiguationTraits {
        .init(
    ...
    @inlinable public func traits(self heir: Symbol.Decl) -> UCF.DisambiguationTraits {
        .init(
            autograph: self.autograph,
            phylum: self.phylum,
            kinks: self.kinks,
