@frozen public struct MajorVersion: Equatable, Hashable, Sendable {
    public var number: Int16

    @inlinable internal init(number: Int16) {
        self.number = number
    }
}
extension MajorVersion {
    @inlinable public static func v(_ number: Int16) -> Self {
...
extension MajorVersion: CustomStringConvertible {
    @inlinable public var description: String { "\(self.number)" }
}
