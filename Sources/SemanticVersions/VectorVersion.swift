public protocol VectorVersion: LosslessStringConvertible, RawRepresentable<Int64>, Comparable {
...
extension VectorVersion where Self: RawRepresentable<Int64> {
    @inlinable public var rawValue: Int64 { self.components.rawValue }
...
extension VectorVersion where Self: LosslessStringConvertible {
    @inlinable public var description: String { self.components.description }
