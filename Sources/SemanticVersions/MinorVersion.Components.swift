extension MinorVersion {
    @frozen public struct Components: Equatable, Hashable, Sendable {
        public var major: Int16
        public var minor: UInt16

        @inlinable internal init(major: Int16, minor: UInt16) {
            self.major = major
            self.minor = minor
        }
    }
...
extension MinorVersion.Components: CustomStringConvertible {
    @inlinable public var description: String { "\(self.major).\(self.minor)" }
}
extension MinorVersion.Components: LosslessStringConvertible, VectorVersionComponents {
    ...
    @inlinable internal init?(_ components: (Substring, Substring)) {
