...
extension Markdown {
    public final class Table: Markdown.BlockElement {
        public var head: Row<HeaderCell>
        public var body: [[BodyCell]]

        public init(columns: [Alignment?] = [], head: [HeaderCell], body: [[BodyCell]]) {
...
extension Markdown.Table {
    @inlinable public var columns: [Alignment?] {
        _read {
...
extension Markdown.Table: RandomAccessCollection {
    ...
    @inlinable public subscript(row: Int) -> Row<BodyCell> {
