...
extension Markdown {
    @frozen public struct InlineHyperlink {
        public var elements: [InlineSpan]
        public var target: Target?

        @inlinable internal init(target: Target?, elements: [InlineSpan]) {
...
extension Markdown.InlineHyperlink {
    public init(
        source: SourceReference<Markdown.Source>,
        target: String?,
...
extension Markdown.InlineHyperlink {
    ...
    /// link text.
    @inlinable public init(source: SourceReference<Markdown.Source>, url: String) {
...
extension Markdown.InlineHyperlink: Markdown.TreeElement {
    public func emit(into binary: inout Markdown.BinaryEncoder) {
        guard
        let target: Target = self.target else {
        ...
        binary[.a] {
            ...
            case .url(let url):
                guard
                let scheme: String = url.scheme else {
