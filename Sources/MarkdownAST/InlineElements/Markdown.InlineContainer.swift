...
extension Markdown {
    @frozen public struct InlineContainer<Element> where Element: Markdown.TextElement {
        public var elements: [Element]
        public var type: InlineContainerType

        @inlinable public init(_ type: InlineContainerType, elements: [Element]) {
            self.type = type
