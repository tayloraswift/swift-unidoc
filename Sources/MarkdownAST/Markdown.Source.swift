...
extension Markdown {
    ...
    public final class Source: Sendable {
        ...
        /// ``SourcePosition/zero``.
        public let origin: SourceLocation<Int32>?
        /// The unparsed markdown source text.
        public let text: String

        @inlinable public init(origin: SourceLocation<Int32>?, text: String) {
            self.origin = origin
            self.text = text
        }
    }
...
extension Markdown.Source: Equatable {
    ...
    @inlinable public static func == (s: Markdown.Source, t: Markdown.Source) -> Bool {
        s === t
    }
}
...
extension Markdown.Source {
    @inlinable public convenience init(file: Int32, text: String) {
        self.init(origin: .init(position: .zero, file: file), text: text)
    }
}
extension Markdown.Source: ExpressibleByStringLiteral {
    @inlinable public convenience init(stringLiteral: String) {
