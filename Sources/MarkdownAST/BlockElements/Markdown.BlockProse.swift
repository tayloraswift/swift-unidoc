...
extension Markdown {
    open class BlockProse: BlockElement {
        public final var elements: [InlineElement]

        @inlinable public init(_ elements: [InlineElement]) {
        ...
        /// this container.
        @inlinable public final override func outline(
        ...
        @inlinable public final override func traverse(
...
extension Markdown.BlockProse {
    ...
    /// sanitization.
    @inlinable public func sanitize(
        with rewrite: (inout Markdown.InlineHyperlink.Target?) throws -> ()
    ) rethrows {
        for index: Int in self.elements.indices {
