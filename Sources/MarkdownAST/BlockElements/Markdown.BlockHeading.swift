...
extension Markdown {
    public final class BlockHeading: BlockProse {
        public let source: SourceReference<Source>?
...
extension Markdown.BlockHeading {
    ...
    @inlinable public func promote(by increment: Int = 1) {
    ...
    @inlinable public func clip(to level: Int) {
    ...
    @inlinable public func anchor() {
        guard
        case nil = self.id,
        self.elements.allSatisfy(\.anchorable) else {
            return
        }
