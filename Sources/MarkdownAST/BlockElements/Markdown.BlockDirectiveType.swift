...
extension Markdown {
    public protocol BlockDirectiveType<Option>: BlockElement {
...
extension Markdown.BlockDirectiveType where Self: Markdown.BlockContainer<
        Markdown.BlockElement
    > {
    public func append(_ element: Markdown.BlockElement) {
