...
extension Markdown.TreeContext {
    struct AttributeList {
        private(set) var others: [(name: HTML.Attribute, value: String)]
        ...
        private(set) var id: URI.Fragment?
...
extension Markdown.TreeContext.AttributeList {
    mutating func append(class enumerated: some RawRepresentable<String>) {
        self.classes.append(enumerated.rawValue)
    }
    mutating func append(value: consuming String, as instruction: Markdown.Bytecode.Attribute) {
        switch instruction {
