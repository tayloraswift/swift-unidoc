extension Phylum {
    @frozen public struct DeclFlags: Equatable, Sendable {
        public let language: Language
        public let phylum: Decl
        public let kinks: Decl.Kinks
        public var route: Decl.Route
...
extension Phylum.DeclFlags {
    @inlinable package static func swift(_ flags: Phylum.SwiftFlags) -> Self {
    ...
    @inlinable public var detail: Bool {
    ...
    @inlinable public var cdecl: Bool {
        switch self.language {
        case .swift:    false
        case .c:        true
        case .cpp:      true
