extension Phylum.Decl {
    @frozen public struct Kinks: Equatable, Hashable, Sendable {
...
extension Phylum.Decl.Kinks: ExpressibleByArrayLiteral {
    @inlinable public init(arrayLiteral: Phylum.Decl.Kink...) {
        self.init(bits: 0)
...
extension Phylum.Decl.Kinks {
    ...
    @inlinable public subscript(is kink: Phylum.Decl.Kink) -> Bool {
        get {
