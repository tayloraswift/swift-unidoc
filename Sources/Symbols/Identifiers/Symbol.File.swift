extension Symbol {
    @frozen public struct File: Equatable, Hashable, Sendable {
...
extension Symbol.File {
    ...
    @inlinable public static func uri(file uri: String) throws -> Self {
        guard
        let start: String.Index = uri.index(
            uri.startIndex,
            offsetBy: 7,
...
extension Symbol.File {
    public mutating func rebase(against base: Symbol.FileBase) throws {
    ...
    public __consuming func rebased(against base: Symbol.FileBase) throws -> Self {
...
extension Symbol.File {
    ...
    @inlinable public var type: Substring? {
...
extension Symbol.File: RawRepresentable {
    @inlinable public var rawValue: String { self.path }
