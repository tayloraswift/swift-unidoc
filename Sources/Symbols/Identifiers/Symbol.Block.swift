extension Symbol {
    @frozen public struct Block: Hashable, Equatable, Sendable {
...
extension Symbol.Block: Comparable {
    @inlinable public static func < (a: Self, b: Self) -> Bool { a.name < b.name }
}
...
extension Symbol.Block: LosslessStringConvertible {
    public init?(_ description: __shared String) {
        guard case .block(let block)? = Symbol.USR.init(description) else {
            return nil
        }
