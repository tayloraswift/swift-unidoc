extension Symbol.Decl {
    ...
    @frozen public struct Vector: Equatable, Hashable {
        public let feature: Symbol.Decl
        public let heir: Symbol.Decl

        @inlinable public init(_ feature: Symbol.Decl, self heir: Symbol.Decl) {
...
extension Symbol.Decl.Vector: LosslessStringConvertible {
    public init?(_ string: __shared String) {
        guard case .vector(let vector)? = Symbol.USR.init(string) else {
            return nil
        }
