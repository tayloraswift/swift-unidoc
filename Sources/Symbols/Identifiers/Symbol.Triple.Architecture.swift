extension Symbol.Triple {
    @frozen public struct Architecture: Equatable, Hashable, Sendable {
...
extension Symbol.Triple.Architecture {
    ...
    public static var aarch64: Self { "aarch64" }

    @available(*, unavailable, message: "Aarch64 can be encoded as either 'arm64' or 'aarch64")
    public static var arm64: Self { "arm64" }

    @inlinable public static var x86_64: Self { "x86_64" }
}
