extension Symbol {
    @frozen public struct Module: Equatable, Hashable, Sendable {
        public let mangled: String

        @inlinable public init(_ mangled: String) {
            self.mangled = mangled
        }
    }
}
extension Symbol.Module: CustomStringConvertible {
    @inlinable public var description: String { self.mangled }
}
...
extension Symbol.Module: Comparable {
    @inlinable public static func < (a: Self, b: Self) -> Bool { a.mangled < b.mangled }
}
extension Symbol.Module {
    public init(mangling name: String) {
        //  Stolen from:
    ...
    private static func mangle(first codepoint: Unicode.Scalar) -> Unicode.Scalar {
        switch codepoint {
        case    "0" ... "9",
            // Annex D.
    ...
    private static func mangle(subsequent codepoint: Unicode.Scalar) -> Unicode.Scalar {
        switch codepoint {
        case    "A" ... "Z",
            "a" ... "z",
            "0" ... "9",
