...
@frozen public struct Signature<Scalar>: Equatable where Scalar: Hashable {
    public var availability: Availability
    public var abridged: Abridged
...
extension Signature {
    @inlinable public func map<T>(_ transform: (Scalar) throws -> T) rethrows -> Signature<T> {
        .init(
