extension Signature {
    @frozen public struct Generics: Equatable, Hashable {
        public var constraints: [GenericConstraint<Scalar>]
        ...
        @inlinable public init(
            constraints: [GenericConstraint<Scalar>] = [],
...
extension Signature.Generics {
    ...
    ) rethrows -> Signature<T>.Generics {
        .init(
            constraints: try self.constraints.map { try $0.map(transform) },
