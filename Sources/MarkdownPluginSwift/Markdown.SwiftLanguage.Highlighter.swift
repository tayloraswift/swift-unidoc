...
extension Markdown.SwiftLanguage {
    @frozen public struct Highlighter {
        @inlinable public init() {
        }
    }
}
extension Markdown.SwiftLanguage.Highlighter: Markdown.CodeHighlighter {
    public func emit(_ text: consuming String, into binary: inout Markdown.BinaryEncoder) {
        ...
        text.withUTF8 {
            guard
            let base: UnsafePointer<UInt8> = $0.baseAddress else {
                return // empty string
            }
