...
extension SignatureSyntax {
    struct Encoder: ~Copyable {
        ...
        private var color: Markdown.Bytecode.Context?
        /// The depth level used to encode the next span.
        private var depth: Span.Depth?
...
extension SignatureSyntax.Encoder {
    consuming func move() -> [SignatureSyntax.Span] { self.spans }

    mutating func wbr(indent: Bool) {
