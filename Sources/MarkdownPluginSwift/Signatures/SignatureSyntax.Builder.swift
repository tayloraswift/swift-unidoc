...
extension SignatureSyntax.Builder {
    private mutating func register(
        parameters clause: FunctionParameterClauseSyntax,
        type: SignatureParameterType,
        trimAfter: Bool = false
    ) {
...
extension SignatureSyntax.Builder<SignatureSyntax.ExpandedVisitor> {
    mutating func encode(decl: DeclSyntax) {
    ...
    private mutating func encode(_ clause: GenericParameterClauseSyntax) {
...
extension SignatureSyntax.Builder<SignatureSyntax.AbridgedVisitor> {
    ...
    private mutating func encode(_ function: FunctionSignatureSyntax) {
    ...
    private mutating func encode(_ modifiers: DeclModifierListSyntax) {
    ...
    private mutating func encode(_ clause: GenericParameterClauseSyntax?) {
        guard
        let clause: GenericParameterClauseSyntax else {
            return
        }
