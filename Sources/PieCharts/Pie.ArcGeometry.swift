...
extension Pie {
    @frozen @usableFromInline struct ArcGeometry {
        ...
        @usableFromInline let startArc: SVG.Point<Double>
        @usableFromInline let endArc: SVG.Point<Double>
...
extension Pie.ArcGeometry {
    @inlinable init(share: Double, from start: SVG.Point<Double>, to end: Double) {
        self.init(
            share: share,
            startArc: start,
