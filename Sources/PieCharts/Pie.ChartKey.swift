...
extension Pie {
    public protocol ChartKey: Identifiable<String> {
...
extension Pie.ChartKey {
    ...
    @inlinable public func legend(_ html: inout HTML.ContentEncoder, share: ShareFormat) {
        guard
        let share: String = share.formatted else {
            return
        }
