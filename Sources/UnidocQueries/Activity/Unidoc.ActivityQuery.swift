...
extension Unidoc {
    @frozen public struct ActivityQuery: Equatable, Hashable, Sendable {
        public let limit: Int

        @inlinable public init(limit: Int = 16) {
            self.limit = limit
        }
    }
}
extension Unidoc.ActivityQuery {
    private static var featured: [Featured<Unidoc.Stem>] {
        [
        ]
    }
}
extension Unidoc.ActivityQuery: Mongo.PipelineQuery {
    ...
    @inlinable public var from: Mongo.Collection? { nil }
