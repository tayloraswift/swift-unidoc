...
extension Unidoc {
    @frozen public struct VersionsQuery: Equatable, Hashable, Sendable {
        public let symbol: Symbol.Package
        public let limitTags: Int
        public let limitBranches: Int
        public let limitDependents: Int
        public let limitBuilds: Int
...
extension Unidoc.VersionsQuery: Unidoc.AliasingQuery {
    ...
    public func extend(pipeline: inout Mongo.PipelineEncoder) {
        ...
        pipeline.loadBranches(
            limit: self.limitBranches,
            from: Self.target,
        ...
        Unidoc.ConsumersPageSegment.bridge(
            pipeline: &pipeline,
