...
extension Unidoc {
    ...
    @frozen public struct PackageCreated: Equatable, Hashable, Sendable {
        @usableFromInline let timeframe: Range<UnixDate>
        @usableFromInline let limit: Int

        @inlinable init(during timeframe: Range<UnixDate>, limit: Int) {
...
extension Unidoc.PackageCreated: Unidoc.PackagePredicate {
    @inlinable public var hint: Mongo.CollectionIndex? { Unidoc.DB.Packages.indexRepoCreated }
