...
extension Unidoc {
    @frozen public struct RedirectOutput: Equatable, Sendable {
        public let matches: [Unidoc.AnyVertex]
        public let volume: Unidoc.VolumeMetadata

        @inlinable internal init(matches: [Unidoc.AnyVertex], volume: Unidoc.VolumeMetadata) {
...
extension Unidoc.RedirectOutput: Mongo.MasterCodingModel {
    @frozen public enum CodingKey: String, CaseIterable, Sendable {
        case matches = "M"
        case volume = "Z"
    }
}
