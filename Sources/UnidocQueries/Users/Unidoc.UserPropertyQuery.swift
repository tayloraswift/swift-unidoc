...
extension Unidoc {
    ...
    @frozen public struct UserPropertyQuery: Sendable {
        public let account: Account

        @inlinable public init(account: Account) {
...
extension Unidoc.UserPropertyQuery: Mongo.PipelineQuery {
    ...
    @inlinable public var hint: Mongo.CollectionIndex? { Unidoc.DB.Packages.indexAccount }
