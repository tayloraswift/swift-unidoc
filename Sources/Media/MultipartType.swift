@frozen public enum MultipartType: Equatable, Hashable, Sendable {
    case byteranges (boundary: String?)
    case form_data  (boundary: String?)
}
extension MultipartType {
    @inlinable public static var byteranges: MultipartType { .byteranges(boundary: nil) }

    @inlinable public static var form_data: MultipartType { .form_data(boundary: nil) }
}
