...
extension GitHub.App {
    @frozen public struct Credentials: Equatable, Hashable, Sendable {
        public var accessToken: String
        public var accessTokenSecondsRemaining: Int64?
        public var refreshToken: String?
        public var refreshTokenSecondsRemaining: Int64?
...
extension GitHub.App.Credentials: JSONObjectDecodable {
    ...
    public init(json: JSON.ObjectDecoder<CodingKey>) throws {
        self.init(
            accessToken: try json[.accessToken].decode(),
