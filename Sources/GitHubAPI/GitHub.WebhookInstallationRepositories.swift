...
extension GitHub {
    @frozen public struct WebhookInstallationRepositories: Equatable, Sendable {
        public let installation: Installation
        public let selection: Selection
        public let delta: Delta

        @inlinable public init(installation: Installation, selection: Selection, delta: Delta) {
