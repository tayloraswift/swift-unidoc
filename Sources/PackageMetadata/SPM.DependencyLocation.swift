...
extension SPM {
    @frozen public enum DependencyLocation: Hashable, Equatable, Sendable {
...
extension SPM.DependencyLocation {
    @inlinable public init(location: String) {
        self = location.first == "/" ?
...
extension SPM.DependencyLocation {
    public var owner: Symbol.PackageScope? {
        switch self {
        case .local:
            return nil
