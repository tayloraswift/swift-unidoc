...
@Suite struct InterestingKeywords {
    ...
    @Test mutating func Actor() {
        let decl: String = "actor MargotRobbie"

        let signature: Signature<Never>.Expanded = .init(
            decl,
    ...
    @Test mutating func ClassSubscript() {
    ...
    @Test mutating func FreestandingMacro() {
        let decl: String = """
    ...
    @Test mutating func AttachedMacro() {
        let decl: String = """
