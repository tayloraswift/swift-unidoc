...
@Suite struct Signatures {
    @Test static func Expanded() {
        let decl: String = """
    ...
    @Test static func ExpandedWithSelf() {
        let decl: String = """
    ...
    @Test static func ExpandedWithInoutSelf() {
        let decl: String = """
    ...
    @Test static func ExpandedWithResultBuilders() {
        let decl: String = """
        init(@Builder<A<B, C>, D> builder:() -> Handler)
        """

        let expanded: Signature<Never>.Expanded = .init(
            decl, linkBoundaries: [
                6, 13,
                14, 15,
                16, 17,
    ...
    @Test static func AbridgedComplex() {
        let decl: String = """
        func transform<IndexOfResult, ElementOfResult>(\
    ...
    @Test static func AbridgedUnlabeledArguments() {
        let decl: String = """
    ...
    @Test static func AbridgedBackDeployed() {
        let decl: String = """
