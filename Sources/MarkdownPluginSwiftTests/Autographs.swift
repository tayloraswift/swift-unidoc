...
@_spi(testable) import MarkdownPluginSwift

@Suite struct Autographs {
    private var landmarks: SignatureLandmarks

    private var dictionary: Signature<Symbol.Decl>.Fragment {
        .init("Dictionary", referent: .sSD)
    }
    private var array: Signature<Symbol.Decl>.Fragment { .init("Array", referent: .sSa) }
    private var optional: Signature<Symbol.Decl>.Fragment { .init("Optional", referent: .sSq) }

    init() {
        self.landmarks = .init()
    }

    @Test mutating func Func1() {
    ...
    @Test mutating func SomeAndAnyTypes() {
        let decl: String = """
        func f(
            a: any Error,
    ...
    @Test mutating func ProtocolCompositions() {
        let decl: String = """
        func f(
            a: any Error,
    ...
    @Test mutating func Noncopyable() {
        let decl: String = """
    ...
    @Test mutating func Resugaring1() {
    ...
    @Test mutating func Resugaring2() {
        let _: Signature<Symbol.Decl>.Expanded = .init(
            [
    ...
    @Test mutating func Resugaring3() {
        let _: Signature<Symbol.Decl>.Expanded = .init(
            [
                "func f(_: ",
                self.array,
    ...
    @Test mutating func DesugaringStaticSelf() {
        let _: Signature<Symbol.Decl>.Expanded = .init(
            [
