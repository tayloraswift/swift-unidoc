...
@Suite enum Parsing {
    ...
    @Test static func CompoundInvalidPrefix() {
        #expect(
            nil == Symbol.USR.init(
    ...
    @Test static func CompoundInvalidInfix() {
        #expect(
            nil == Symbol.USR.init(
    ...
    @Test static func CompoundInvalidSuffix() {
        #expect(
            nil == Symbol.USR.init(
    ...
    @Test static func MacroDollarIdentifier() {
        let expected: Symbol.Decl.Vector = .init(
            .init(.s, ascii: """
    ...
    @Test static func Chimaeric() {
        let expected: Symbol.Decl.Vector = .init(
            .init(.s, ascii: "SQsE2neoiySbx_xtFZ"),
