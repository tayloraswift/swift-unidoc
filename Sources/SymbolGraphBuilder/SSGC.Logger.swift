...
extension SSGC {
    public final class Logger {
        private let validation: ValidationBehavior
        private let output: FileDescriptor?

        private(set) var failed: Bool

        public init(validation: ValidationBehavior, file output: FileDescriptor?) {
...
extension SSGC.Logger: DiagnosticLogger {
    public func emit(messages: consuming DiagnosticMessages) throws {
