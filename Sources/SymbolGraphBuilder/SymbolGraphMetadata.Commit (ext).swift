...
{
    static
    func parenthesizedSwiftRelease(_ string:Substring) -> Self?
    {
        guard string.startIndex < string.endIndex
        else
        {
            return nil
        }
        ...
        case ("(", ")") = (string[string.startIndex], string[bounds.1])
        else
        {
            return nil
        }
        ...
        case ("swift", "-RELEASE") = (content[..<i], content[j...])
        else
        {
            return nil
        }
