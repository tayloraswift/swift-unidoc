...
@frozen public
struct TargetIdentifier:StringIdentifier, Equatable, Hashable, Sendable
{
    public
...
extension TargetIdentifier:Comparable
{
}
extension TargetIdentifier:ExpressibleByStringLiteral
{
}
extension TargetIdentifier
{
    public
    var mangled:ModuleIdentifier
    {
        //  Stolen from:
        //  https://github.com/apple/swift-tools-support-core/blob/main/Sources/TSCUtility/StringMangling.swift
        var codepoints:String.UnicodeScalarView.Iterator =
            self.description.unicodeScalars.makeIterator()
        var mangled:String = ""
