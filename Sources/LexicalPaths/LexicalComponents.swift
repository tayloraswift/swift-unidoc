@frozen public struct LexicalComponents<Last> where Last: CustomStringConvertible {
    public var prefix: [String]
    public var last: Last

    @inlinable public init(_ prefix: [String], _ last: Last) {
        self.prefix = prefix
        self.last = last
    }
}
...
extension LexicalComponents where Last: LexicalContinuation {
    @inlinable public mutating func append(_ component: Last) {
