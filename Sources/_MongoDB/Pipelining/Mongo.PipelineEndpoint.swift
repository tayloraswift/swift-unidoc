...
extension Mongo {
    ...
    public protocol PipelineEndpoint<Query> {
        ...
        static var replica: ReadPreference { get }
        ...
        mutating func yield(batch: [Query.Iteration.BatchElement]) throws
        ...
        mutating func pull(from database: Database, with session: Session) async throws
    }
}
extension Mongo.PipelineEndpoint where Query.Iteration.Stride == Never {
    @inlinable public var stride: Never { [][0] }
}
extension Mongo.PipelineEndpoint
    ...
    @inlinable public mutating func pull(
...
extension Mongo.PipelineEndpoint {
    ...
    @inlinable public mutating func pull(from database: some Mongo.DatabaseModel) async throws {
