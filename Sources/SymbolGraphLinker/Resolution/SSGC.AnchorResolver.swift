...
extension SSGC {
    public struct AnchorResolver {
        private var table: [Int32: [UCF.AnchorMangling: String]]

        public init(table: [Int32: [UCF.AnchorMangling: String]] = [:]) {
            self.table = table
        }
    }
}
extension SSGC.AnchorResolver {
    mutating func index(article: Markdown.SemanticSections, id: Int32?) -> SSGC.AnchorTable {
