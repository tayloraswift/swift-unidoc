...
extension SymbolGraph {
    ...
    @frozen public struct ArticleNode: Equatable, Sendable {
        public var headline: Markdown.Bytecode
        public var article: Article

        @inlinable public init(headline: Markdown.Bytecode, article: Article = .init()) {
...
extension SymbolGraph.ArticleNode: SymbolGraphNode {
    public typealias Plane = SymbolGraph.ArticlePlane
    public typealias ID = Symbol.Article

    @inlinable public var isCitizen: Bool { true }
}
