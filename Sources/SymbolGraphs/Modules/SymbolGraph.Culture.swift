...
extension SymbolGraph {
    @frozen public struct Culture: Equatable, Sendable {
        ...
        public var namespaces: [SymbolGraph.Namespace]
        /// Declarations this module re-exports, if any.
        public var reexports: Reexports

        /// This module’s standalone articles, if it has any.
        public var articles: ClosedRange<Int32>?
        ...
        @inlinable public init(module: Module) {
            self.module = module
...
extension SymbolGraph.Culture: Identifiable {
    @inlinable public var id: Symbol.Module {
        self.module.id
    }
}
extension SymbolGraph.Culture {
    @inlinable public var decls: ClosedRange<Int32>? {
