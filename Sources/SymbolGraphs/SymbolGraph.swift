...
@frozen public struct SymbolGraph: Equatable, Sendable {
    ...
    public var namespaces: [Symbol.Module]
    ...
    ///
    /// New in 0.8.24.
    public var curation: [[Int32]]

    public var articles: Layer<ArticleNode>
    public var decls: Layer<DeclNode>

    public var files: Table<FilePlane, Symbol.File>
...
extension SymbolGraph {
    ...
    /// with a culture.
    @inlinable public mutating func append(namespace: Symbol.Module) -> Int {
...
extension SymbolGraph {
    @inlinable public func link<T>(
        _ transform: (Symbol.Module, Int32) throws -> T,
        dynamic link: (Symbol.Module) throws -> T
    ) rethrows -> [T] {
        ...
        for (index, id): (Int, Symbol.Module) in zip(self.namespaces.indices, self.namespaces) {
            elements.append(
                self.cultures.indices.contains(index)
