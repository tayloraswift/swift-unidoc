...
extension SymbolGraph {
    ...
    @frozen public struct DeclNode: Equatable, Sendable {
        public var extensions: [Extension]
        public var decl: Decl?

        @inlinable public init(extensions: [Extension] = [], decl: Decl? = nil) {
...
extension SymbolGraph.DeclNode: SymbolGraphNode {
    public typealias Plane = SymbolGraph.DeclPlane
    public typealias ID = Symbol.Decl

    /// A declaration node is a citizen of its symbol graph if and only if ``decl`` is non-nil.
    @inlinable public var isCitizen: Bool { self.decl != nil }
}
extension SymbolGraph.DeclNode {
    public mutating func push(_ extension: __owned SymbolGraph.Extension) -> Int {
