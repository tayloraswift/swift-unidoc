...
extension SymbolGraph {
    @frozen public struct Extension: Equatable, Sendable {
        public let conditions: [GenericConstraint<Int32>]
        ...
        public let culture: Int

        public var conformances: [Int32]
        ...
        public var nested: [Int32]

        public var article: Article?

        @inlinable public init(
            conditions: [GenericConstraint<Int32>],
            namespace: Int,
            culture: Int,
            conformances: [Int32] = [],
            features: [Int32] = [],
