...
extension SymbolGraph {
    @frozen public struct Decl: Equatable, Sendable {
        ...
        public var kinks: Phylum.Decl.Kinks
        public var route: Phylum.Decl.Route
    ...
    @inlinable public init(bson: BSON.DocumentDecoder<CodingKey>) throws {
        ...
        self.init(
            ...
            requirements: try bson[.requirements]?.decode(
                as: SymbolGraph.Buffer24.self,
                with: \.elements
            ) ?? [],
            inhabitants: try bson[.inhabitants]?.decode(
                as: SymbolGraph.Buffer24.self,
                with: \.elements
            ) ?? [],
