extension MultipartForm {
    @frozen public struct Iterator {
        @usableFromInline internal var base: IndexingIterator<MultipartView>

        @inlinable internal init(base: IndexingIterator<MultipartView>) {
            self.base = base
        }
    }
}
extension MultipartForm.Iterator: IteratorProtocol {
    public mutating func next() -> MultipartForm.Item? {
