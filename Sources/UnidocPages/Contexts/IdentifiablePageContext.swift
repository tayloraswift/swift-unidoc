...
{
    convenience
    init(principal scalar:Unidoc.Scalar, volume:Volume.Metadata, repo:Unidoc.PackageMetadata.Repo?)
    {
...
{
    convenience
    init(principal volume:Volume.Metadata, repo:Unidoc.PackageMetadata.Repo?)
    {
        self.init(cache: .init(
