...
extension Swiftinit.Docs.Decl:RenderablePage
{
...
extension Swiftinit.Docs.Decl:StaticPage
{
    var location:URI { Swiftinit.Docs[self.volume, self.vertex.shoot] }
}
extension Swiftinit.Docs.Decl:ApplicationPage
{
    typealias Navigator = HTML.Logo
}
extension Swiftinit.Docs.Decl:VersionedPage
{
