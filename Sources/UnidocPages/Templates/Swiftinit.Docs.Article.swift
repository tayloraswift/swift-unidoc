...
extension Swiftinit.Docs.Article:RenderablePage
{
...
extension Swiftinit.Docs.Article:StaticPage
{
    var location:URI { Swiftinit.Docs[self.volume, self.vertex.shoot] }
}
extension Swiftinit.Docs.Article:ApplicationPage
{
    typealias Navigator = HTML.Logo
}
extension Swiftinit.Docs.Article:VersionedPage
{
