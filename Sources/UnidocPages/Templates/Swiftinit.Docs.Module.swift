...
extension Swiftinit.Docs.Module:RenderablePage
{
...
extension Swiftinit.Docs.Module:StaticPage
{
    var location:URI { Swiftinit.Docs[self.volume, self.vertex.shoot] }
}
extension Swiftinit.Docs.Module:ApplicationPage
{
    typealias Navigator = HTML.Logo
}
extension Swiftinit.Docs.Module:VersionedPage
{
