...
extension Swiftinit.Stats.Module:RenderablePage
{
...
extension Swiftinit.Stats.Module:StaticPage
{
    var location:URI { Swiftinit.Stats[self.volume, self.vertex.shoot] }
}
extension Swiftinit.Stats.Module:ApplicationPage
{
    typealias Navigator = HTML.Logo
}
extension Swiftinit.Stats.Module:VersionedPage
{
