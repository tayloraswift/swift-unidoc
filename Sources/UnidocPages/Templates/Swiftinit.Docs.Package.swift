...
extension Swiftinit.Docs.Package:RenderablePage
{
...
extension Swiftinit.Docs.Package:StaticPage
{
    var location:URI { Swiftinit.Docs[self.volume] }
}
extension Swiftinit.Docs.Package:ApplicationPage
{
    typealias Navigator = HTML.Logo
}
extension Swiftinit.Docs.Package:VersionedPage
{
