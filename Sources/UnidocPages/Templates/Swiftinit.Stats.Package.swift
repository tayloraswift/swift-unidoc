...
extension Swiftinit.Stats.Package:RenderablePage
{
...
extension Swiftinit.Stats.Package:StaticPage
{
    var location:URI { Swiftinit.Stats[self.volume] }
}
extension Swiftinit.Stats.Package:ApplicationPage
{
    typealias Navigator = HTML.Logo
}
extension Swiftinit.Stats.Package:VersionedPage
{
