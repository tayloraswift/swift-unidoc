...
extension Swiftinit.Docs.MultipleFound:RenderablePage
{
    var title:String { "Disambiguation Page - \(self.volume.title) Documentation" }
}
extension Swiftinit.Docs.MultipleFound:StaticPage
{
    var location:URI
    {
...
extension Swiftinit.Docs.MultipleFound:ApplicationPage
{
    typealias Navigator = HTML.Logo
}
extension Swiftinit.Docs.MultipleFound:VersionedPage
{
