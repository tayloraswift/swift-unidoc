...
extension Swiftinit.AdminPage.Recode:RenderablePage
{
    public
    var title:String { "Schema - Administrator Tools" }
}
extension Swiftinit.AdminPage.Recode:StaticPage
{
    public
    var location:URI { Self.uri }
}
extension Swiftinit.AdminPage.Recode:AdministrativePage
{
    public
