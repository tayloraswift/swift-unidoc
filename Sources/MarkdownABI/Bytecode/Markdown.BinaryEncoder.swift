extension Markdown {
    @frozen public struct BinaryEncoder {
        @usableFromInline internal var attribute: AttributeEncoder
...
extension Markdown.BinaryEncoder {
    @inlinable public internal(set) var bytecode: Markdown.Bytecode {
        _read {
...
extension Markdown.BinaryEncoder {
    @inlinable public static func += (self: inout Self, bytecode: Markdown.Bytecode) {
        self.bytecode.bytes += bytecode.bytes
    }

    @inlinable public static func += (self: inout Self, codepoint: Unicode.Scalar) {
        self.bytecode.write(utf8: codepoint.utf8)
    }
    @inlinable public static func += (self: inout Self, character: Character) {
        self.bytecode.write(utf8: character.utf8)
    }
    @inlinable public static func += (self: inout Self, text: some StringProtocol) {
        self.bytecode.write(text: text)
    }
    @inlinable public static func += (self: inout Self, utf8: some Sequence<UInt8>) {
        self.bytecode.write(utf8: utf8)
    }
    @inlinable public static func &= (self: inout Self, reference: Int) {
        self.bytecode.write(reference: reference)
    }
}
extension Markdown.BinaryEncoder {
    @inlinable public subscript(
        _ emission: Markdown.Bytecode.Emission,
        attributes: (inout Markdown.AttributeEncoder) -> () = { _ in }
    ) -> Void {
        mutating get {
    ...
    @inlinable public subscript(
        _ context: Markdown.Bytecode.Context,
        attributes: (inout Markdown.AttributeEncoder) -> (),
        content encode: (inout Self) -> () = { _ in }
    ) -> Void {
        mutating get {
            attributes(&self.attribute)
...
extension Markdown.BinaryEncoder {
    ...
    @inlinable public subscript<String>(
        _ context: Markdown.Bytecode.Context,
        attributes: (inout Markdown.AttributeEncoder) -> () = { _ in }
    ) -> String?
