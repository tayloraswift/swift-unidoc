...
extension TargetNode {
    @frozen public struct Dependencies: Equatable, Sendable {
        public var products: [Dependency<Symbol.Product>]
        public var targets: [Dependency<String>]
        public var nominal: [Dependency<String>]
