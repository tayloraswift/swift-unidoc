...
@Suite enum Sorting {
    ...
    @Test static func DivergingStar() {
        Self.test(
            nodes: ["A", "B", "C", "D"],
            edges: [
                "A": "B",
    ...
    @Test static func LipsAsymmetric() {
        Self.test(
            nodes: ["4", "0", "5", "2", "3", "1"],
            edges: [
                "4": "0",
