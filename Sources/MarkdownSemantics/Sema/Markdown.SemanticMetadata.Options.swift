extension Markdown.SemanticMetadata {
    @frozen public struct Options {
        public var automaticSeeAlso: Option<Bool>?
        public var automaticTitleHeading: Option<Bool>?
...
extension Markdown.SemanticMetadata.Options: ExpressibleByDictionaryLiteral {
    @inlinable public init(dictionaryLiteral: (Never, Bool)...) {
        self.init()
    }
}
extension Markdown.SemanticMetadata.Options {
    ...
    @inlinable public mutating func propogate(from other: Self) {
