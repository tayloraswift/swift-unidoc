...
extension Markdown {
    @frozen public struct SemanticSections {
        public var parameters: BlockParameters?
        public var returns: BlockAside.Returns?
        public var `throws`: BlockAside.Throws?

        public var article: [BlockElement]
...
extension Markdown.SemanticSections {
    public func anchors() -> [UCF.AnchorMangling: String] {
...
extension Markdown.SemanticSections {
    ...
    @inlinable public func traverse(with visit: (Markdown.BlockElement) throws -> ()) rethrows {
