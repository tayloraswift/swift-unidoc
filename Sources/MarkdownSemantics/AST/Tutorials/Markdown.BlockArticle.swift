...
extension Markdown {
    public class BlockArticle: BlockElement {
        ...
        private(set) var overview: Intro?
        private(set) var sections: [BlockElement]
        ...
        public final override func traverse(with visit: (BlockElement) throws -> ()) rethrows {
        ...
        public func append(_ element: BlockElement) throws {
            ...
            if  case let section as Section = element {
                ...
                guard
                case let intro as Intro = element else {
