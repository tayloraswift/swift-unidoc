...
extension Markdown.TutorialIndex {
    class ExternalLinks: Markdown.BlockContainer<Markdown.BlockElement> {
        ...
        final override func emit(into binary: inout Markdown.BinaryEncoder) {
            binary[.section] {
...
extension Markdown.TutorialIndex.ExternalLinks: Markdown.BlockDirectiveType {
    ...
    final func configure(option: Option, value: Markdown.SourceString) throws {
        switch option {
        case .destination:
            guard case nil = self.destination else {
