...
{
    func `case`<Value>(_ value:Markdown.SourceString,
        of _:Value.Type = Value.self) throws -> Value
    ...
    func cast<Value>(_ value:Markdown.SourceString,
        to _:Value.Type = Value.self) throws -> Value
