...
extension Markdown {
    public final class BlockParameters: BlockElement {
        public let discussion: [BlockElement]
        public let list: [BlockParameter]

        @inlinable public init(_ discussion: [BlockElement], list: [BlockParameter] = []) {
        ...
        public override func traverse(with visit: (BlockElement) throws -> ()) rethrows {
