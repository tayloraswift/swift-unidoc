...
extension Markdown.BlockMetadata {
    final class DocumentationExtension: Markdown.BlockLeaf {
        private(set) var mergeBehavior: Markdown.SemanticMetadata.MergeBehavior?
...
extension Markdown.BlockMetadata.DocumentationExtension: Markdown.BlockDirectiveType {
    ...
    func configure(option: Option, value: Markdown.SourceString) throws {
        switch option {
        case .mergeBehavior:
            guard case nil = self.mergeBehavior else {
