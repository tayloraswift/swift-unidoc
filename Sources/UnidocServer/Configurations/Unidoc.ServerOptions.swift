...
extension Unidoc {
    @frozen public struct ServerOptions: Sendable {
        public var assetCache: Unidoc.Cache<Unidoc.Asset>?
        public var builders: Int
        public var bucket: Buckets
        public var github: (any GitHub.Integration)?
