...
extension Unidoc.ReallyPage {
    static func unlink(_ action: URI) -> Self {
        .init(
            title: "Unlink symbol graph?",
            prompt: """
    ...
    static func delete(_ action: URI) -> Self {
        .init(
            title: "Delete symbol graph?",
            prompt: """
            Nobody will be able to read the documentation for this version of the package. \
    ...
    static func packageConfig(
        _ action: URI,
        update: Unidoc.PackageConfigOperation.Update
    ) -> Self? {
        switch update {
        case .expires:
            return .init(
                title: "Refresh package tags?",
                prompt: """
    ...
    static func userConfig(_ action: URI, update: Unidoc.UserConfigOperation.Update) -> Self {
        switch update {
        case .generateKey:
            return .init(
