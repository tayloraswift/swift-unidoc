...
extension ServerProfile.Sample
{
    var _language:WritableKeyPath<ServerProfile.ByLanguage, Int>
    {
        guard
    ...
    var _agent:WritableKeyPath<ServerProfile.ByAgent, Int>
    {
        guard
        let agent:String = self.agent
        else
        {
            return \.likelyTool
        }
