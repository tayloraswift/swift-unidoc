...
extension Unidoc.DB.DocsFeed: Mongo.CollectionModel {
    public typealias Element = Activity<Unidoc.Edition>

    @inlinable public static var name: Mongo.Collection { "DocsFeed" }

    public static let indexes: [Mongo.CollectionIndex] = [
        .init(
            "Volume",
            collation: .simple,
            unique: true
...
extension Unidoc.DB.DocsFeed {
    public func push(_ activity: Activity<Unidoc.Edition>) async throws -> Bool {
