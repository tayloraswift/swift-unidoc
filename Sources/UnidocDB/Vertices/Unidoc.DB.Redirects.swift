...
extension Unidoc.DB {
    @frozen public struct Redirects {
...
extension Unidoc.DB.Redirects {
    public static let indexPaths: Mongo.CollectionIndex = .init(
        "Paths",
...
extension Unidoc.DB.Redirects: Mongo.CollectionModel {
    public typealias Element = Unidoc.RedirectVertex

    @inlinable public static var name: Mongo.Collection { "VolumeRedirects" }

    @inlinable public static var indexes: [Mongo.CollectionIndex] { [ Self.indexPaths ] }
}
