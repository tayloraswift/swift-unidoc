...
extension Unidoc.DB.Vertices {
    public static let indexStem: Mongo.CollectionIndex = .init(
        "Stem",
    ...
    public static let indexHash: Mongo.CollectionIndex = .init(
        "Hash",
        collation: .casefolding,
        unique: true
    ) {
    ...
    public static let indexLinkableFlag: Mongo.CollectionIndex = .init(
        "LinkableFlag",
        unique: true
    ) {
    ...
    public static let indexLinkablePath: Mongo.CollectionIndex = .init(
        "LinkablePath",
        collation: .casefolding
    ) {
...
extension Unidoc.DB.Vertices: Mongo.CollectionModel {
    public typealias Element = Unidoc.AnyVertex

    @inlinable public static var name: Mongo.Collection { "VolumeVertices" }
...
extension Unidoc.DB.Vertices {
    @discardableResult
    func insert(
        _ vertices: Unidoc.Mesh.Vertices,
        trunk: Symbol.Package?
