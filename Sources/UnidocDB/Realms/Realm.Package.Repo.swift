...
@available(*, deprecated, renamed: "Realm.Package.Repo")
public
typealias PackageRepo = Realm.Package.Repo
...
extension Realm.Package.Repo:MongoMasterCodingModel
{
    @frozen public
...
extension Realm.Package.Repo:BSONDocumentEncodable
{
    public
...
extension Realm.Package.Repo:BSONDocumentDecodable
{
    @inlinable public
