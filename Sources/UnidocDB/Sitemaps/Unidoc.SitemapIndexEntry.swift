...
extension Unidoc {
    ...
    /// sitemap index file.
    @frozen public struct SitemapIndexEntry: Equatable, Sendable {
        public let modified: UnixMillisecond?
        public let symbol: Symbol.Package

        @inlinable internal init(modified: UnixMillisecond?, symbol: Symbol.Package) {
