...
extension Unidoc.DB {
    @frozen public struct SearchbotGrid {
...
extension Unidoc.DB.SearchbotGrid {
    ...
    public static let indexCollated: Mongo.CollectionIndex = .init(
        "Collated",
...
extension Unidoc.DB.SearchbotGrid: Mongo.CollectionModel {
    public typealias Element = Unidoc.SearchbotCell

    @inlinable public static var name: Mongo.Collection { "SearchbotGrid/2" }

    @inlinable public static var indexes: [Mongo.CollectionIndex] { [Self.indexCollated] }
}
extension Unidoc.DB.SearchbotGrid {
    public func match(
