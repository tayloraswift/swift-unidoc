...
extension Unidoc {
    @frozen public struct SearchbotStats: Identifiable, Sendable {
        public let id: Package
        public let harvested: UnixMillisecond

        public var bingbot: Counts
        public var googlebot: Counts
        public var yandexbot: Counts
