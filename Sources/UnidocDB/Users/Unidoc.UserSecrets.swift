...
extension Unidoc {
    @frozen public struct UserSecrets: Equatable, Hashable, Sendable {
        ...
        @inlinable init(account: Account, cookie: Int64, apiKey: Int64?, symbol: String?) {
