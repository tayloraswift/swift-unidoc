...
extension Unidoc.DB {
    @frozen public struct PackageDependencies {
...
extension Unidoc.DB.PackageDependencies: Mongo.CollectionModel {
    public typealias Element = Unidoc.PackageDependency

    @inlinable public static var name: Mongo.Collection { "PackageDependencies" }
...
extension Unidoc.DB.PackageDependencies {
    func update(
        ...
        //  Upsert new edges.
        let upsertion: Mongo.UpdateResponse<
            Unidoc.Edge<Unidoc.Package>
