...
extension Unidoc {
    @frozen public struct Alias<Symbol, Target>: Identifiable, Equatable, Sendable
        ...
        public let coordinate: Target.ID

        @inlinable public init(id: Symbol, coordinate: Target.ID) {
            self.id = id
...
extension Unidoc {
    @frozen public enum AliasKey: String, Sendable {
        case id = "_id"
        case coordinate = "p"
    }
}
extension Unidoc.Alias: Mongo.MasterCodingModel {
    public typealias CodingKey = Unidoc.AliasKey
}
