...
@frozen public struct PackageSubscription {
    ...
    public let till: PatchVersion?

    @inlinable public init(id: ID, from: PatchVersion, till: PatchVersion?) {
        self.id = id
        self.from = from
        self.till = till
    }
