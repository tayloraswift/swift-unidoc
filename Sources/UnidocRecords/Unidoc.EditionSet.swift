...
extension Unidoc {
    struct EditionSet: Equatable, Sendable {
        private(set) var ordered: [Edition]
        private var seen: Set<Edition>

        private init(ordered: [Edition], seen: Set<Edition>) {
...
extension Unidoc.EditionSet {
    mutating func update(with zone: Unidoc.Edition) {
...
extension Unidoc.EditionSet {
    ...
    mutating func update(with scalars: [Unidoc.Scalar]) {
