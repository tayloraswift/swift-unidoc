...
extension Unidoc {
    @frozen public struct PackageMetadata: Identifiable, Sendable {
        ...
        public var realmAligning: Bool

        public var editors: [Account]

        /// The remote git repo this package tracks.
        ///
        /// Currently only GitHub repos are supported.
        public var repo: PackageRepo?
...
extension Unidoc.PackageMetadata {
    ...
    @inlinable public var book: Bool {
