...
extension Unidoc {
    @frozen public struct Snapshot: Identifiable, Equatable, Sendable {
        ...
        public var inline: SymbolGraph?

        public var action: LinkerAction?
...
extension Unidoc.Snapshot {
    @inlinable public var path: Unidoc.GraphPath { .init(edition: self.id, type: self.type) }
}
extension Unidoc.Snapshot {
