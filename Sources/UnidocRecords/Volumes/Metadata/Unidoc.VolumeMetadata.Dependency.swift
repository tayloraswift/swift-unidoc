...
extension Unidoc.VolumeMetadata {
    @frozen public struct Dependency: Equatable, Sendable {
        ...
        public let exonym: Symbol.Package

        public var requirement: SymbolGraphMetadata.DependencyRequirement?
        public var resolution: PatchVersion?
        public var pin: DependencyPin?

        @inlinable public init(
            exonym: Symbol.Package,
