...
extension Unidoc {
    @frozen public struct Census: Equatable, Sendable {
        /// System programming interfaces.
        public var interfaces: BSON.HomogenousFields<Interface, Int>

        public var unweighted: Stats
        public var weighted: Stats

        @inlinable public init(
            interfaces: BSON.HomogenousFields<Interface, Int> = [:],
