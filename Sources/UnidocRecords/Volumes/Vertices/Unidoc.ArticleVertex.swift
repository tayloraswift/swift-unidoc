...
extension Unidoc {
    @frozen public struct ArticleVertex: Identifiable, Equatable, Sendable {
        public let id: Unidoc.Scalar
        public var stem: Unidoc.Stem

        public var culture: Unidoc.Scalar
...
extension Unidoc.ArticleVertex: Unidoc.PrincipalVertex {
    @inlinable public var hash: FNV24.Extended { .init(hashing: "\(self.stem)") }
