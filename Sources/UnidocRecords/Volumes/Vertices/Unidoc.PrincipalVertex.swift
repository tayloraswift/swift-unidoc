...
extension Unidoc {
    ...
    public protocol PrincipalVertex: Identifiable<Unidoc.Scalar> {
...
extension Unidoc.PrincipalVertex {
    @inlinable public var outlinesConcatenated: [Unidoc.Outline] {
...
extension Unidoc.PrincipalVertex {
    @inlinable public var route: Unidoc.Route { .init(shoot: self.shoot) }

    @inlinable public var shoot: Unidoc.Shoot { .init(stem: self.stem) }
}
