...
extension Unidoc {
    @frozen public struct ForeignVertex: Identifiable, Equatable, Sendable {
        public let id: Unidoc.Scalar

        public let extendee: Unidoc.Scalar
        ...
        public let hash: FNV24.Extended
...
extension Unidoc.ForeignVertex {
    ...
    @inlinable public var phylum: Phylum.Decl { self.flags.phylum }

    @inlinable public var kinks: Phylum.Decl.Kinks { self.flags.kinks }
}
