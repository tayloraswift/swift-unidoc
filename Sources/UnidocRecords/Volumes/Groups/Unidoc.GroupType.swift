...
extension Unidoc {
    ...
    @frozen public enum GroupType: UInt32, Equatable, Sendable {
...
extension Unidoc.GroupType {
    @inlinable public func id(_ i: Int, in edition: Unidoc.Edition) -> Unidoc.Group {
...
extension Unidoc.GroupType {
    @inlinable internal static func of(_ scalar: Int32) -> Self? {
