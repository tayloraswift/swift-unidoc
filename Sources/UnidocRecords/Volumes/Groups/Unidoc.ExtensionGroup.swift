...
extension Unidoc {
    ...
    @frozen public struct ExtensionGroup: Identifiable, Equatable, Sendable {
        public let id: Unidoc.Group

        public let constraints: [GenericConstraint<Unidoc.Scalar>]
        public let culture: Unidoc.Scalar
        public let scope: Unidoc.Scalar

        public var conformances: [Unidoc.Scalar]
        public var features: [Unidoc.Scalar]
        public var nested: [Unidoc.Scalar]
        public var subforms: [Unidoc.Scalar]
...
extension Unidoc.ExtensionGroup {
    ...
    public consuming func subtracting(_ members: Set<Unidoc.Scalar>) -> Self {
