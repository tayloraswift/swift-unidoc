...
//     func assign(request:Unidoc.BuildRequest,
//         package:Unidoc.Package,
//         builder:Unidoc.Account) async throws -> Unidoc.PackageMetadata?
//     {
...
//         //     query: .init(package: package, version: request.series))

//         // try await pipeline.pull(from: self.unidoc.id, with: session)
...
//         // if  case .auto = request,
//         //     case _? = output.version.graph
//         // {
//         //     //  Already have a symbol graph for this version.
//         //     return nil
//         // }

//         return try await self.packages.assignBuild(of: package,
//             request: request,
//             builder: builder,
//             with: session)
