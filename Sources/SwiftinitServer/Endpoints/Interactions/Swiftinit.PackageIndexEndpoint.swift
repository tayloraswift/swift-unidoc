...
extension Swiftinit.PackageIndexEndpoint:Swiftinit.RestrictedEndpoint
{
        ...
        with session:Mongo.Session) async throws -> HTTP.ServerResponse?
    {
        ...
        {
            let display:Swiftinit.PolicyErrorPage = .init(illustration: .error4xx_jpg,
        ...
        {
            let display:Swiftinit.PolicyErrorPage = .init(illustration: .error404_jpg,
