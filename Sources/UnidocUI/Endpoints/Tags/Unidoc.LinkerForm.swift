...
extension Unidoc {
    @frozen public struct LinkerForm {
        public let edition: Edition
        public let back: String

        @inlinable public init(edition: Edition, back: String) {
...
extension Unidoc.LinkerForm {
    ...
    public init?(parameters: borrowing [String: String]) {
        guard
        ...
        let version: Unidoc.Version = .init(version) else {
            return nil
        }
