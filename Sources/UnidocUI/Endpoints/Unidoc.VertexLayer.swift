...
extension Unidoc {
    ...
    public protocol VertexLayer {
        ...
        static var hist: ServerRoot { get }
    }
}
extension Unidoc.VertexLayer {
    private static subscript(volume: Unidoc.VolumeSelector, cdecl cdecl: Bool) -> URI {
    ...
    static subscript(volume: Unidoc.VolumeMetadata, route: Unidoc.Route) -> URI {
    ...
    static subscript(volume: Unidoc.VolumeMetadata) -> URI {
