...
extension Unidoc {
    @frozen public struct ExportEndpoint: Mongo.PipelineEndpoint, Mongo.SingleOutputEndpoint {
        public let rateLimit: HTTP.Resource.Headers.RateLimit
...
extension Unidoc.ExportEndpoint: Unidoc.VertexEndpoint {
    public typealias VertexLayer = Unidoc.DocsEndpoint
