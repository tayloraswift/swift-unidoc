...
extension Unidoc {
    @frozen public struct StatsEndpoint: Mongo.PipelineEndpoint, Mongo.SingleOutputEndpoint {
        public let query: VertexQuery<LookupLimited>
        public var value: VertexOutput?

        @inlinable public init(query: VertexQuery<LookupLimited>) {
            self.query = query
            self.value = nil
        }
    }
...
extension Unidoc.StatsEndpoint: Unidoc.VertexLayer {
    @inlinable public static var docs: Unidoc.ServerRoot { .stats }

    @inlinable public static var docc: Unidoc.ServerRoot { .stats }

    @inlinable public static var hist: Unidoc.ServerRoot { .stats }
}
