...
extension Unidoc.IdentifiablePageContext {
    struct Cache {
        private(set) var vertices: Table
        var volumes: Unidoc.VolumeContext

        private var uris: [Unidoc.Scalar: String]
        private(set) var used: [Unidoc.Scalar]
...
extension Unidoc.IdentifiablePageContext.Cache {
    mutating func load(
        _ id: Unidoc.Scalar,
        by uri: (Unidoc.VolumeMetadata) -> URI?
    ) -> Unidoc.LinkTarget? {
        {
    ...
    private mutating func load<Vertex>(
        _ id: Unidoc.Scalar,
        vertex: Vertex,
        principal: Bool
    ) -> Unidoc.LinkReference<Vertex>
