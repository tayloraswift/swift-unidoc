...
extension Unidoc {
    public final class ExternalBlogContext: IdentifiablePageContext<IdentifiableVertices> {
        public override subscript(
            vertex id: Unidoc.Scalar
        ) -> Unidoc.LinkReference<Unidoc.AnyVertex>? {
            guard
            var link: Unidoc.LinkReference<Unidoc.AnyVertex> = super[vertex: id] else {
                return nil
            }
