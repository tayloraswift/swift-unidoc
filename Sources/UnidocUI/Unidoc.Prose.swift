...
extension Unidoc
{
    struct Prose
    {
        ...
        private
        let details:Markdown.Bytecode?

        private
        init(outlines:[Unidoc.Outline], overview:Markdown.Bytecode?, details:Markdown.Bytecode?)
        {
...
extension Unidoc.Prose
{
    ...
    {
        self.init(outlines: apex.outlinesConcatenated,
