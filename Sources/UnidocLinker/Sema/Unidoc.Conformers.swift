...
extension Unidoc {
    struct Conformers: Identifiable {
        ...
        private var unconditional: [Unidoc.Scalar]
        private var conditional: [ConformingType]
...
extension Unidoc.Conformers: Unidoc.LinkerIndexable {
    ...
    static var type: Unidoc.GroupType { .conformer }
