...
extension Unidoc {
    struct ExtensionSignature: Equatable, Hashable {
        ...
        private init(conditions: ExtensionConditions, extendee: Unidoc.Scalar) {
...
extension Unidoc.ExtensionSignature {
    static func extends(
        _ extendee: consuming Unidoc.Scalar,
        where conditions: consuming Unidoc.ExtensionConditions
    ) -> Self {
