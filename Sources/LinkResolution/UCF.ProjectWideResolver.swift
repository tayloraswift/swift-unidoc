...
extension UCF {
    @frozen public struct ProjectWideResolver {
        @usableFromInline let scope: ResolutionScope

        @usableFromInline let global: ResolutionTable<PackageOverload>
        @usableFromInline let causal: ResolutionTable<CausalOverload>?
...
extension UCF.ProjectWideResolver {
    public func resolve(
        _ selector: UCF.Selector
    ) throws -> UCF.Resolution<any UCF.ResolvableOverload> {
