...
extension UCF {
    @frozen public struct ResolutionTable<Overload> where Overload: ResolvableOverload {
        @usableFromInline var entries: [UCF.ResolutionPath: InlineArray<Overload>]
        @usableFromInline var modules: [UCF.ResolutionPath: Symbol.Module]
...
extension UCF.ResolutionTable: ExpressibleByDictionaryLiteral {
    @inlinable public init(dictionaryLiteral: (Never, Never)...) { self.init() }
}
...
extension UCF.ResolutionTable {
    @inlinable public mutating func register(_ module: Symbol.Module) {
...
extension UCF.ResolutionTable {
    public func resolve(qualified: UCF.Selector) throws -> UCF.Resolution<Overload> {
    ...
    private func resolve(
        qualified path: UCF.Selector.Path,
        with search: inout Search
    ) -> UCF.Resolution<Overload> {
