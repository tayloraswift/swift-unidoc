...
{
    @frozen public
    struct Clauses<Domain> where Domain:AvailabilityDomain
    {
        public
        let unavailable:Domain.Unavailability?
        public
        let deprecated:Domain.Deprecation?
        public 
        let introduced:Domain.Bound?
        public 
        let obsoleted:Domain.Bound?
        public 
        let renamed:String?
        public 
        let message:String?
        ...
        @inlinable public
        init(unavailable:Domain.Unavailability? = nil,
