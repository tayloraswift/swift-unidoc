@frozen public struct Availability: Equatable, Sendable {
    public var universal: Clauses<UniversalDomain>?

    public var platforms: [PlatformDomain: Clauses<PlatformDomain>]
    public var agnostic: [AgnosticDomain: Clauses<AgnosticDomain>]

    @inlinable public init(
        _ universal: Clauses<UniversalDomain>? = nil,
