extension Unidoc {
    @frozen public struct Scalar: Equatable, Hashable, Sendable {
        public let package: Package
        public let version: Version
        public let citizen: Int32

        @inlinable public init(package: Package, version: Version, citizen: Int32) {
...
extension Unidoc.Scalar: CustomStringConvertible {
    @inlinable public var description: String {
        "\(self.package):\(self.version):\(self.citizen)"
    }
}
