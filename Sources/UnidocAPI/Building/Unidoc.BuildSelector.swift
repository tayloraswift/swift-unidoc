extension Unidoc {
    @frozen public enum BuildSelector<Package> {
...
extension Unidoc.BuildSelector<Void> {
    @inlinable public static func latest(_ series: Unidoc.VersionSeries) -> Self {
        .latest(series, of: ())
    }
}
extension Unidoc.BuildSelector {
    @inlinable public var exact: Unidoc.Edition? {
        switch self {
        case .id(let id):   id
        case .latest:       nil
        }
