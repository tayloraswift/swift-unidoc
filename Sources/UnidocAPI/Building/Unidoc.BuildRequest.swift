...
extension Unidoc {
    @frozen public struct BuildRequest<Package> {
        public let version: BuildSelector<Package>
        public let rebuild: Bool

        @inlinable public init(version: BuildSelector<Package>, rebuild: Bool) {
...
extension Unidoc.BuildRequest<Unidoc.Package> {
    public init?(query: borrowing URI.Query) {
